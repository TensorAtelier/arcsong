...
- The page has Create / Library / Setup views on `#/`, `#/library`, `#/setup`, and Compare on `#/compare/<group id>`; it opens on Setup while not ready. `--engine fake` writes 20 s tones whose pitch depends on the seed.
